...
public class BackHairCtl : MonoBehaviour
{
    Slider slider;
    float sliderValue;
    ...
    void Update()
    {
        if (slider.value <= 1.0 / 7)
        {
            ...
            bh6.transform.localScale = new Vector3(0, 1, 1);
            bh7.transform.localScale = new Vector3(0, 1, 1);
        }
        else if (slider.value <= 2.0 / 7)
        {
        ...
        else if (slider.value <= 6.0 / 7)
        {
            ...
            bh4.transform.localScale = new Vector3(0, 1, 1);
            bh5.transform.localScale = new Vector3(0, 1, 1);
            bh6.transform.localScale = new Vector3(1, 1, 1);
            bh7.transform.localScale = new Vector3(0, 1, 1);
        }
        else if (slider.value <= 1.0 )
        {
            ...
            bh5.transform.localScale = new Vector3(0, 1, 1);
            bh6.transform.localScale = new Vector3(0, 1, 1);
            bh7.transform.localScale = new Vector3(1, 1, 1);
        }
    }
}
